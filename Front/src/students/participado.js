...
class ShowParticipado extends Component{
    ...
    componentDidMount() {
        ...
        let global = "http://35.226.163.50:8080/Backend/users/student/" + id + "/getAllProblems";
        axios.get(global)
            .then(res => {
        ...
        return(
            <div id="problems" className = "problems">
                ...
                <Grid>
                    <Row > 
                        <Col md={12} xs={12}>
                        <h1  className="center"><Label id="title">Problemas en los que he participado:</Label></h1>
                        </Col>
                    </Row>
                    <br/>
                    {
...
export default ShowParticipado;    